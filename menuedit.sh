...
echo -e "${BICyan} │  ${BICBlue}CPU Info        \t: ${BIBlue}$cores Cores @ $freq MHz (${cpu_usage}) ${NC}\t\t${BICyan}"
echo -e "${BICyan} │  ${IBlue}Total RAM       \t: ${IBlue}${ram_used}MB / ${total_ram}MB (${ram_usage}%) ${NC} \t\t${BICyan}"
echo -e "${BICyan} │  ${IRed}System Uptime   \t: ${IRed}$uptime${NC}\t\t\t${BICyan}"
echo -e "${BICyan} │  ${IGreen}Current Domain  \t: ${IGreen}$(cat /etc/xray/domain)${NC}\t\t\t${BICyan}│"
