...
echo -e "${BICyan} │  ${BIBlue}CPU Info        \t: ${BIBlue}$cores Cores @ $freq MHz (${cpu_usage}) ${NC}\t\t${BICyan}"
echo -e "${BICyan} │  ${GB}Total RAM       \t: ${GB}${ram_used}MB / ${total_ram}MB (${ram_usage}%) ${NC} \t\t${BICyan}"
echo -e "${BICyan} │  ${BIRed}System Uptime   \t: ${BIRed}$uptime${NC}\t\t\t${BICyan}"
echo -e "${BICyan} │  ${BIGreen}Current Domain  \t: ${IBGreen}$(cat /etc/xray/domain)${NC}\t\t\t${BICyan}│"
#echo -e "${BICyan} │  ${BICyan}IP-VPS          \t: ${BIGreen}$IPVPS${NC}\t\t${BICyan}│"
echo -e "${BICyan} │  ${BIYellow}Daily Bandwidth \t: ${BIYellow}$daily_usage ${NC} \t\t\t\t${BICyan}│"
echo -e "${BICyan} │  ${YB}Total Bandwidth \t: ${YB}$monthly_usage ${NC}\t\t\t\t${BICyan}│"
echo -e "${BICyan} └──────────────────────────────────────────────────────────────┘${NC}"
...
echo -e "${BIGreen} |  ${BICyan}[${BIWhite}02${BICyan}] VMESS       ${WB}[${GB}${vmess}${WB}] \t\t${BICyan}[${BIWhite}07${BICyan}] RENEW CERT \t${BIGreen}|"    
echo -e "${BIGreen} |  ${BICyan}[${BIWhite}03${BICyan}] VLESS       ${WB}[${GB}${vless}${WB}] \t\t${BICyan}[${BIWhite}08${BICyan}] EDIT BANNER \t${BIGreen}|"    
echo -e "${BIGreen} |  ${BICyan}[${BIWhite}04${BICyan}] TROJAN      ${WB}[${GB}${tr}${WB}] \t\t${BICyan}[${BIWhite}09${BICyan}] RUNNING STATUS \t${BIGreen}|" 
echo -e "${BIGreen} |  ${BICyan}[${BIWhite}05${BICyan}] SHADOWSOCKS ${WB}[${GB}${ss}${WB}] \t\t${BICyan}[${BIWhite}10${BICyan}] USER BANDWIDTH \t${BIGreen}|"   
echo -e "${BIGreen} └──────────────────────────────────────────────────────────────┘${NC}"
...
echo -e "${IGreen} |  ${BICyan}[${BIWhite}16${BICyan}] TASK MANAGER    \t\t${BICyan}[${BIWhite}23${BICyan}] INSTALL SLOWDNS \t${IGreen}|"
echo -e "${IGreen} |  ${BICyan}[${BIWhite}17${BICyan}] DNS CHANGER     \t\t${BICyan}[${BIWhite}24${BICyan}] INSTALL UDPCUSTOM \t${IGreen}|"
#echo -e "${BICyan} ────────────────────────────────────────────────────────────────${NC}"
echo -e "${IGreen} └──────────────────────────────────────────────────────────────┘${NC}"
echo -e "${IYellow} ┌──────────────────────── Menu Server ─────────────────────────┐${NC}"
#echo -e "${BICyan}                 ${BIWhite}${UWhite}»»» Menu Server «««${NC}"
#echo -e " "
echo -e "${IYellow} |  ${BICyan}[${BIWhite}33${BICyan}] EXP FILES ${NC} \t\t\t${BICyan}[${BIWhite}66${BICyan}] RESTART ${NC} \t\t${IYellow}|"    
echo -e "${IYellow} |  ${BICyan}[${BIWhite}44${BICyan}] AUTO REBOOT ${NC} \t\t\t${BICyan}[${BIWhite}77${BICyan}] BACKUP/RESTORE \t${IYellow}|${NC}"    
echo -e "${IYellow} |  ${BICyan}[${BIWhite}55${BICyan}] REBOOT ${NC} \t\t\t${BICyan}[${BIRed}XX${BICyan}]${BIRed} EXIT \t\t${IYellow}|"     
echo -e "${IYellow} └──────────────────────────────────────────────────────────────┘${NC}"
echo
